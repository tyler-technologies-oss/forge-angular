...
import { AppBarHelpButtonComponent as AppBarHelpButtonComponentCustomElement } from '@tylertech/forge';
...
export class AppBarHelpButtonComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-app-bar-help-button')) {
			window.customElements.define('forge-app-bar-help-button', AppBarHelpButtonComponentCustomElement);
		}
