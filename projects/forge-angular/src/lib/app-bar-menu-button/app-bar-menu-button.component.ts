...
import { AppBarMenuButtonComponent as AppBarMenuButtonComponentCustomElement } from '@tylertech/forge';
...
export class AppBarMenuButtonComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-app-bar-menu-button')) {
			window.customElements.define('forge-app-bar-menu-button', AppBarMenuButtonComponentCustomElement);
		}
