...
import { BusyIndicatorComponent as BusyIndicatorComponentCustomElement } from '@tylertech/forge';
...
export class BusyIndicatorComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-busy-indicator')) {
			window.customElements.define('forge-busy-indicator', BusyIndicatorComponentCustomElement);
		}
