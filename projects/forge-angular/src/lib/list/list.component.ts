...
import { ListComponent as ListComponentCustomElement } from '@tylertech/forge';
...
export class ListComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-list')) {
			window.customElements.define('forge-list', ListComponentCustomElement);
		}
