...
import { MiniDrawerComponent as MiniDrawerComponentCustomElement } from '@tylertech/forge';
...
export class MiniDrawerComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-mini-drawer')) {
			window.customElements.define('forge-mini-drawer', MiniDrawerComponentCustomElement);
		}
