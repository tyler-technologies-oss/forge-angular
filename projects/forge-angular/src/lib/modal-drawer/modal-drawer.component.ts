...
import { ModalDrawerComponent as ModalDrawerComponentCustomElement } from '@tylertech/forge';
...
export class ModalDrawerComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-modal-drawer')) {
			window.customElements.define('forge-modal-drawer', ModalDrawerComponentCustomElement);
		}
