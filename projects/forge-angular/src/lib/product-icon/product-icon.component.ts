...
import { ProductIconComponent as ProductIconComponentCustomElement } from '@tylertech/forge';
...
export class ProductIconComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-product-icon')) {
			window.customElements.define('forge-product-icon', ProductIconComponentCustomElement);
		}
