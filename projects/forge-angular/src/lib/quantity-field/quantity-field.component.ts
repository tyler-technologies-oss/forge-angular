...
import { QuantityFieldComponent as QuantityFieldComponentCustomElement } from '@tylertech/forge';
...
export class QuantityFieldComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-quantity-field')) {
			window.customElements.define('forge-quantity-field', QuantityFieldComponentCustomElement);
		}
