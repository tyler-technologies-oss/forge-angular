...
import { RippleComponent as RippleComponentCustomElement } from '@tylertech/forge';
...
export class RippleComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-ripple')) {
			window.customElements.define('forge-ripple', RippleComponentCustomElement);
		}
