...
import { StepperComponent as StepperComponentCustomElement } from '@tylertech/forge';
...
export class StepperComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-stepper')) {
			window.customElements.define('forge-stepper', StepperComponentCustomElement);
		}
