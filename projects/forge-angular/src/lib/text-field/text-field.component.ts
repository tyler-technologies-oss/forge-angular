...
import { TextFieldComponent as TextFieldComponentCustomElement } from '@tylertech/forge';
...
export class TextFieldComponent {
	...
	constructor(
		...
		if (!window.customElements.get('forge-text-field')) {
			window.customElements.define('forge-text-field', TextFieldComponentCustomElement);
		}
