...
const routes: Routes = [
  ...
  { path: 'popover', loadChildren: () => import('../../views/components/popover/popover.module').then(m => m.PopoverModule) },
  { path: 'circular-progress', loadChildren: () => import('../../views/components/circular-progress/circular-progress.module').then(m => m.CircularProgressModule) },
