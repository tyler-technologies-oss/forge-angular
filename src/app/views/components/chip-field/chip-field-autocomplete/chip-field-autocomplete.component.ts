...
@Component({
    ...
    imports: [ForgeAutocompleteProxyModule, ForgeAutocompleteModule, FormsModule, ForgeChipFieldModule, NgFor, ForgeChipProxyModule, ForgeIconModule, ForgeCheckboxProxyModule, ForgeCheckboxModule]
})
